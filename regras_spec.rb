...
describe Regras do
  ...
  context "Soma dos valores via ID" do
    it "ID 1 tem o valor de 45" do
      obj = Regras.new()
      val = obj.soma_valores(1)
      expect(val).to eq(45)
    end
    it "ID 2 tem o valor de 55" do
      obj = Regras.new()
      val = obj.soma_valores(2)
      expect(val).to eq(55)
    end
    it "ID 3 tem o valor de 100" do
      obj = Regras.new()
      val = obj.soma_valores(3)
      expect(val).to eq(100)
    end
    it "ID 4 tem o valor de 55" do
      obj = Regras.new()
      val = obj.soma_valores(4)
      expect(val).to eq(55)
    end
    it "ID 5 tem o valor de 100" do
      obj = Regras.new()
      val = obj.soma_valores(5)
      expect(val).to eq(100)
    end
    it "ID 2 tem o valor de 55" do
      obj = Regras.new()
      val = obj.soma_valores(6)
